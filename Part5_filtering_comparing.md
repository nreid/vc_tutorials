...
In this section of the tutorial, we'll cover ways you can filter and compare sets of variants. We'll also learn how to get database identifiers for variants that have already been discovered and do some basic prediction of their functional effects, tasks which fall under the umbrella of "annotation."

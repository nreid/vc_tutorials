...
samtools sort -n - | \
bedtools bamtofastq -i /dev/stdin/ -fq test.1.fq -fq2 test.2.fq
...
samtools sort -n - | \
bedtools bamtofastq -i /dev/stdin/ -fq mom.1.fq -fq2 mom.2.fq
...
samtools sort -n - | \
bedtools bamtofastq -i /dev/stdin/ -fq dad.1.fq -fq2 dad.2.fq
